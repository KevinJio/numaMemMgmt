...
static int xen_smp_intr_init(unsigned int cpu)
{
	...
	/* Added by KevinJio */
	printk(KERN_INFO "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n");
	topology_name = kasprintf(GFP_KERNEL, "topology%d", cpu);
	rc = bind_virq_to_irqhandler(VIRQ_TOPOLOGY, cpu, xen_topology_interrupt_handler,
				     IRQF_PERCPU | IRQF_NOBALANCING,
				     topology_name, NULL);
	if (rc < 0)
		goto fail;
	...
	printk(KERN_INFO "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb\n");
	/* End of the addition */
