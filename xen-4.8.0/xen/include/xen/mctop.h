...
#define MCTOP_LVL_ID_MULTI 10000
  ...
  typedef struct hwc_gs		/* group / socket */
  {
	...
	uint nr_mem_ranges_elts; // The number of memory addresses forming the ranges belonging to this node
...
mctop_t* extract_sub_topology(mctop_t* src, mctop_t* dest, int* pcpu_ids, int nb_hwcs);
