...
/*  static uint mctop_create_id(uint seq_id, uint lvl)
  {
    return ((lvl * MCTOP_LVL_ID_MULTI) + seq_id);
  }
*/

/*  static uint mctop_id_no_lvl(uint id)
  {
    return (id % MCTOP_LVL_ID_MULTI);
  }
*/

/*  static uint mctop_id_get_lvl(uint id)
  {
    return (id / MCTOP_LVL_ID_MULTI);
  }*/

/*  static void mctop_print_id(uint id)
  {
...
#define MCTOP_ID_PRINT(id)  mctop_id_get_lvl(id), mctop_id_no_lvl(id)
...
#if defined(__i386__)
  /*static mctop_ticks mctop_getticks(void)
  {
    mctop_ticks ret;
  ...
  /*static mctop_ticks mctop_getticks()
  {
    mctop_ticks ret = 0;
